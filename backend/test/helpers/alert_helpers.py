...
AlertDataDict = typing.TypedDict('AlertDataDict', {'alert_level': str, 'basin_names': typing.List[str]})



def create_alertlvl_basin_dict(input_alert_data_dict_list: AlertDataDict) -> typing.Dict[str, typing.List[str]]:
    """
    ...
    for input_alert_data_dict in input_alert_data_dict_list:
        for basin_name in input_alert_data_dict["basin_names"]:
            if input_alert_data_dict["alert_level"] in alert_lvl_basin_dict:
                alert_lvl_basin_dict[input_alert_data_dict["alert_level"]].append(basin_name)
            else:
                alert_lvl_basin_dict[input_alert_data_dict["alert_level"]] = [basin_name]
